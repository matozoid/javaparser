 ...
 */
public final class PlaceholderStmt extends Statement {
    ...
    public PlaceholderStmt(final String label) {
        this(null, new SimpleName(label));
    }

    @AllFieldsConstructor
    public PlaceholderStmt(final SimpleName label) {
        this(null, label);
    }
    ...
    public PlaceholderStmt(TokenRange tokenRange, SimpleName label) {
        super(tokenRange);
        setLabel(label);
     ...
     */
    @Generated("com.github.javaparser.generator.core.node.PropertyGenerator")
    public PlaceholderStmt setLabel(final SimpleName label) {
        if (label == this.label) {
